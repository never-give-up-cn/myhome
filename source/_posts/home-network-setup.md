...
{% img /img/topo-full.png '"家庭网络完整拓扑图" "网络拓扑"' %}
...
要让内网设备（192.168.1.0/24）和 DMZ 服务器（10.0.2.0/24）互通，需要在**软路由**、**路由器**和 **H3C 防火墙**上分别添加静态路由：
...
| 设备 | 目标网段 | 下一跳 | 出接口 | 说明 |
|------|---------|--------|--------|------|
| **软路由** 192.168.100.1 | 10.0.2.0/24 | 192.168.100.254 | LAN | 去 DMZ 走防火墙管理口 |
| **路由器** 192.168.1.1 | 10.0.2.0/24 | 192.168.100.1 | WAN | 去 DMZ 走软路由 |
| **H3C 防火墙** 192.168.100.254 | 192.168.1.0/24 | 192.168.100.1 | Trust | 去内网走软路由 |
| **R730xd / VM** 10.0.2.x | 192.168.1.0/24 | 10.0.2.1 | DMZ | 去内网走防火墙 DMZ 网关 |
